  ...
  protected function executeBltUpdate($version) {
    ...
    if ($this->isInitialInstall()) {
      ...
      if ($this->isNewProject()) {
        ...
        $success = $this->executeCommand($this->getVendorPath() . '/acquia/blt/bin/blt create-project', [], TRUE);
      }
      else {
        $success = $this->executeCommand($this->getVendorPath() . '/acquia/blt/bin/blt add-to-project', [], TRUE);
      }
    }
