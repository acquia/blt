...
1. Create a new project using the [blt-project](https://github.com/acquia/blt-project) template by running the following commands in the directory in which you'd like to create your new project. Do not run these commands inside of an existing git repository. Replace `MY_PROJECT` in the commands below with the desired name of your new project directory.
