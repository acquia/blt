...
/**
 * Any file placed directly in the docroot/sites directory whose name matches a
 * glob pattern of *.settings.php will be incorporated to the settings of every
 * defined site.
 *
